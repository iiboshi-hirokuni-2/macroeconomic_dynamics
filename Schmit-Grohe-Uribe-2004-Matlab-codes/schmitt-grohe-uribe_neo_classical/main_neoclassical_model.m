...
[fx,fxp,fy,fyp,fypyp,fypy,fypxp,fypx,fyyp,fyy,...
    fyxp,fyx,fxpyp,fxpy,fxpxp,fxpx,fxyp,fxy,fxxp,fxx,f] = neoclassical_model;

%% Numerical Evaluation
% Non-stochastic  Steady State and Parameter Values
...
[gxx,hxx] = gxx_hxx(nfx,nfxp,nfy,nfyp,nfypyp,nfypy,nfypxp,...
                    nfypx,nfyyp,nfyy,nfyxp,nfyx,nfxpyp,...
                    nfxpy,nfxpxp,nfxpx,nfxyp,nfxy,nfxxp,nfxx,hx,gx) 

[gss,hss] = gss_hss(nfx,nfxp,nfy,nfyp,nfypyp,nfypy,nfypxp,nfypx,...
                    nfyyp,nfyy,nfyxp,nfyx,nfxpyp,nfxpy,nfxpxp,nfxpx,...
                    nfxyp,nfxy,nfxxp,nfxx,hx,gx,gxx,eta)
