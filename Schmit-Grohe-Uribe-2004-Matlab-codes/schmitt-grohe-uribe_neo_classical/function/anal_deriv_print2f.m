...
%        ETASHOCK: symbolic matrix scaling std dev of shocks 
%                (the evolution of the state  is: x_t+1 = hx x_t + ETASHOCK epsilon_t+1, where epsilon_t+1 has an identity var/cov matrix)
% output: m-file "filename_num_eval.m" 

% by Andrea Pescatori Jun 18 2008, modified Aug 08
function anal_deriv_print2f(filename,fx,fxp,fy,fyp,f,ETASHOCK, ...
