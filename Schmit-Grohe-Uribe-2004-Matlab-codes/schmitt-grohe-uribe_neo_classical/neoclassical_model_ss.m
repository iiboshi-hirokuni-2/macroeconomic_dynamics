...
%This program produces the the deep structural parameters and computes the steady state of...
% the simple neoclassical growth model described in section 2.1 of
