%GSS_HSS.M
%Finds the vectors gss and hss necessary to compute the 2nd order approximation 
% to the decision rules of a DSGE model. 
% For documentation, see the paper ``Solving Dynamic General Equilibrium Models 
% Using a Second-Order Approximation to the Policy Function,'' 
% by Stephanie Schmitt-Grohe and Martin Uribe, 2001)
%
% INPUTS: fx,fxp,fy,fyp,fypyp,fypy,fypxp,fypx,fyyp,fyy,fyxp,fyx,fxpyp,
%         fxpy,fxpxp,fxpx,fxyp,fxy,fxxp,fxx,hx,gx,gxx,eta
%
%  OUTPUTS: hss gss
%
