%ASSET_MODEL.M
function [nfx,nfxp,nfy,nfyp,nfypyp,nfypy,nfypxp,nfypx,...
    nfyyp,nfyy,nfyxp,nfyx,nfxpyp,nfxpy,nfxpxp,nfxpx,...
    nfxyp,nfxy,nfxxp,nfxx,eta] = asset_model(P)
...
[XBAR, RHO, THETA, BETTA,eta,sig,p,pp,a,ap] = asset_ss(P);
