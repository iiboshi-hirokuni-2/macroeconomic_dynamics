%ASSET_SS_LINEAR
function [XBAR, RHO, THETA, BETTA,eta,sig,p,pp,a,ap] = asset_ss(P)
...
RHO =P.RHO; %-0.139; %persistence parameter of growth rate of dividend process

THETA = P.THETA; %-1.5; %Curvature of single-period utility funciton

BETTA = 0.95; %subjective discount factor
sig = P.SIG ; %1.0 %parameter scaling the vector of innovations
...
save('p_bar.mat','p','a','sig','eta','BETTA');