...
if not(exist(folder_name,'dir'))
   ...
   for  Panel=1:2 % choose from 1 to 6
         ...
         if Panel==1,        theta1=2.0; theta2=0.00;  theta3=0.08; theta4=0.00;  theta5 = 0.98;
                                     x_i=1; y_i=2;  
                                   disp('Panel A:  psi_pi (1) vs psi_pi (2) ')
         elseif Panel==2,     theta1=2.0; theta2=0.00;  theta3=0.08; theta4=0.00; theta5 = 0.98;
                                    x_i=1; y_i=3;                        
...
%           theta2=0.9;  sigma=1.0;   % <---- Setting 
    ...
    vn{5}='\beta'; vn{6}='\varphi';  vn{7}='\sigma'; 
        ...
        par_L=[0.75    0.00    0.00     0.00    0.985   1/4     0.5 ];   % Lower bound
        par_U=[2.50    1.05    0.10     0.10    0.999   1.0     2.0   ];   % Upper bound
